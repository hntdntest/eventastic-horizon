              ...
              <CardContent className="pt-6">
                <div className="space-y-6">
                  ...
                  <div className="flex justify-end pt-4">
                    <Button onClick={() => navigateToTab("speakers")}>{t('organizer.basic.saveContinue')}</Button>
                  </div>
                </div>
              </CardContent>
            </TabsContent>
            <TabsContent value="speakers">
              <CardContent className="pt-6">
                <div className="space-y-6">
                  ...
                  <div className="flex justify-end pt-4">
                    <Button onClick={() => navigateToTab("schedule")}>{t('organizer.basic.saveContinue')}</Button>
                  </div>
                </div>
              </CardContent>
            </TabsContent>
